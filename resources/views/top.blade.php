                ...
                <div class="p-2 flex flex-col items-start">
                    ...
                    <div class="flex items-center flex-wrap pb-4 mb-4 border-b-2 border-gray-100 mt-auto w-full">
                        ...
                        <span
                            ...
                            <svg class="w-5 h-5 mr-1 text-blue-300" stroke="currentColor" stroke-width="2" fill="none"
                        ...
                        <span class="text-gray-500 inline-flex items-center leading-none text-2xl">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-1 text-yellow-300" fill="none"
